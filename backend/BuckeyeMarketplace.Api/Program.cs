...
builder.Services.AddDbContext<BuckeyeMarketplaceContext>(options =>
    options.UseInMemoryDatabase("BuckeyeMarketplaceDb"));
    ...
    if (!context.Products.Any())
    {
        context.Products.AddRange(
            ...
            new Product
            {
                ...
                SellerName = "Ava P.",
                PostedDate = "2026-03-01",
                ImageUrl = "https://images.unsplash.com/photo-1711344397160-b23d5deaa012?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            },
            new Product
            {
                Id = 3,
